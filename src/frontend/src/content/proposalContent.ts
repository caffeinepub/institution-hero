...
export const proposalContent = {
  ...
  subtitle:
    "Heroes and Villains in Higher Education: Resilience and The Role of Next Generation Student Leaders",
  ...
  activities: {
    activity1: {
      ...
      examples:
        "ethical, visionary, authentic, resilient, empathetic, principled, transformational, courageous, accountable, inclusive, decisive, adaptable, humble, inspiring, grounded",
      reflectionPrompts: [
